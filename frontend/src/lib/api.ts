...
const DEFAULT_PREDICTION: Prediction = {
  ...
  base_date_formatted: "Friday, 25 Sep 2026",
  target_date: "2026-09-28",
  target_date_formatted: "Monday, 28 Sep 2026",
  ...
  confidence: 0.4231,
  confidence_pct: "42.3%",
  transition_formula: "P(X_{t+1} | X_t=Upward, R_t=SN)",
};
